...
VALUES (100016, 'Apple', 5, 100009),
       ...
       (100029, 'Vodka', 250, 100015),
       (100032, 'Snikers', 15, 100031);
...
VALUES (100023, '2018-09-01', 100002, 100004),
       ...
       (100030, CURRENT_DATE, 100002, 100005);

INSERT INTO restaurant_votes (restaurant_id, votes_id)
VALUES (100004, 100023),
       (100005, 100024),
       (100006, 100025),
       (100007, 100026),
       (100008, 100027),
...
INSERT INTO menu_meals (menu_id, meals_id)
VALUES (100009, 100016),
       (100010, 100017),
       (100011, 100018),
       (100012, 100019),
       (100013, 100020),
